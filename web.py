...
connection=mysql.connector.connect(host="localhost",user="root",password="Jishab@12",database="Railway")
...
@app.route("/travelupdates")
def travelupdates():
    return render_template("travelupdates.html")
